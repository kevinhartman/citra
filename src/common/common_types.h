...
template<typename T>
struct Rect {
    T x0_;    ///< Rect top left X-coordinate
    T y0_;    ///< Rect top left Y-coordinate
    T x1_;    ///< Rect bottom left X-coordinate
    T y1_;    ///< Rect bottom right Y-coordinate
...
struct Point {
    ...
    inline bool operator == (const Point& val) const {
